// Auto update 
  ...
  document.getElementById("due").addEventListener("click",()=>{
      ...
      window.location.href="duepayment.html"
  })
  ...
  function addTransactionItem() {
            ...
            const container = document.getElementById('transactionContainerForaccount');
          
            const entries = JSON.parse(localStorage.getItem('AddMoneyTxn')) || [];
                ...
                <div class="transaction-item">
                    <div class="transaction-details">
                        ...
                        <div class="transaction-info">
                            <p class="transaction-name">${entry.transactiontype}</p>
                            <p class="transaction-category">Source:${entry.source}</p>
                        </div>
                    </div>
                    <div class="transaction-amount">
                        <p><b>${entry.amount}</b></p>
                    </div>
                </div>
            `;
